...
export default function Employees() {
  ...
  // Fetch all employees (fetch large number to get all, then filter client-side) - optimized query
  ...
  // Fetch roles for filter - optimized query
        ...
        <CardContent>
          <div className="flex flex-col sm:flex-row gap-4">
            ...
            <Select 
              ...
              onValueChange={(value) => {
                handleRoleFilterChange(value === "all" ? "" : value);
                setPage(1);
              }}
            >
