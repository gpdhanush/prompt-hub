...
export default function MyDevices() {
  ...
  // Fetch assigned assets - optimized query
  ...
  // Fetch categories - optimized query
  ...
  const assets = useMemo(() => assignedAssets?.data || [], [assignedAssets?.data]);
  const categories = useMemo(() => categoriesData?.data || [], [categoriesData?.data]);
  const selectedCategory = useMemo(() => 
    categories.find((cat: any) => cat.id.toString() === formData.asset_category_id),
    [categories, formData.asset_category_id]
  );
  ...
  // Filter assets based on search and filters - memoized
  ...
  }, [formData, categoryName, createAndAssignMutation]);
  ...
  const handleNestedFormFieldChange = useCallback((parentField: string, field: string, value: any) => {
    setFormData(prev => {
      const parentValue = prev[parentField as keyof typeof prev] as any;
      return {
        ...prev,
        [parentField]: {
          ...parentValue,
  ...
  const handleViewDevice = useCallback((assetId: number) => {
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      ...
                      <Select
                        ...
                        onValueChange={(value) => handleFormFieldChange('asset_category_id', value)}
                        required
                      >
                        <SelectTrigger>
                    ...
                    <div>
                      ...
                      <DatePicker
                        ...
                        onChange={(date) => handleFormFieldChange('purchase_date', date || "")}
                    ...
                    <div>
                      ...
                      <DatePicker
                        ...
                        onChange={(date) => handleFormFieldChange('warranty_expiry', date || "")}
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      <div>
                        ...
                        <Input
                          ...
                          onChange={(e) => handleNestedFormFieldChange('laptop_details', 'os_type', e.target.value)}
                      ...
                      <div>
                        ...
                        <Input
                          ...
                          onChange={(e) => handleNestedFormFieldChange('laptop_details', 'mac_address', e.target.value)}
                      ...
                      <div>
                        ...
                        <Input
                          ...
                          onChange={(e) => handleNestedFormFieldChange('laptop_details', 'processor', e.target.value)}
                      ...
                      <div>
                        ...
                        <Input
                          ...
                          onChange={(e) => handleNestedFormFieldChange('laptop_details', 'ram_gb', e.target.value)}
                          placeholder="16"
                        />
                      </div>
                      <div>
                        ...
                        <Input
                          ...
                          onChange={(e) => handleNestedFormFieldChange('laptop_details', 'storage_gb', e.target.value)}
                          placeholder="512"
                        />
                      </div>
                      <div>
                        ...
                        <Input
                          ...
                          onChange={(e) => handleNestedFormFieldChange('laptop_details', 'screen_size', e.target.value)}
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      <div>
                        ...
                        <Input
                          ...
                          onChange={(e) => handleNestedFormFieldChange('mobile_details', 'device_type', e.target.value)}
                      ...
                      <div>
                        ...
                        <Input
                          ...
                          onChange={(e) => handleNestedFormFieldChange('mobile_details', 'imei_1', e.target.value)}
                      ...
                      <div>
                        ...
                        <Input
                          ...
                          onChange={(e) => handleNestedFormFieldChange('mobile_details', 'imei_2', e.target.value)}
                          placeholder="15-digit IMEI"
                        />
                      </div>
                      <div>
                        ...
                        <Input
                          ...
                          onChange={(e) => handleNestedFormFieldChange('mobile_details', 'storage_gb', e.target.value)}
                          placeholder="128"
                        />
                      </div>
                    </div>
                  ...
                  <CardContent className="space-y-4">
                    <div>
                      ...
                      <Textarea
                        ...
                        onChange={(e) => handleNestedFormFieldChange('accessory_details', 'specification', e.target.value)}
                    ...
                    <div>
                      ...
                      <Input
                        ...
                        onChange={(e) => handleNestedFormFieldChange('accessory_details', 'compatibility', e.target.value)}
