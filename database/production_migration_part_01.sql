-- ============================================
-- PRODUCTION DATABASE MIGRATIONS - PART 01
-- ============================================
-- Core Schema: Authentication, Authorization, Users, Employees, Projects
-- Database: prasowla_ntpl_admin
-- MySQL 8.0+
-- ============================================
-- IMPORTANT: Run parts in sequence (01, 02, 03, 04, 05, 06)
-- ============================================
...
CREATE TABLE IF NOT EXISTS `reimbursements` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  `uuid` VARCHAR(36) NULL UNIQUE,
  `claim_code` VARCHAR(50) NULL UNIQUE,
  `employee_id` INT UNSIGNED NOT NULL,
  ...
  `approved_by` INT UNSIGNED,
  `approved_at` TIMESTAMP NULL,
  `level_1_approved_by` INT UNSIGNED NULL,
  `level_1_approved_at` TIMESTAMP NULL,
  `level_1_rejected_by` INT UNSIGNED NULL,
  `level_1_rejected_at` TIMESTAMP NULL,
  `level_1_rejection_reason` TEXT NULL,
  `super_admin_approved_by` INT UNSIGNED NULL,
  `super_admin_approved_at` TIMESTAMP NULL,
  `super_admin_rejected_by` INT UNSIGNED NULL,
  `super_admin_rejected_at` TIMESTAMP NULL,
  `super_admin_rejection_reason` TEXT NULL,
  `current_approval_level` ENUM('Level 2', 'Level 1', 'Super Admin', 'Completed') DEFAULT 'Level 2',
  `rejection_reason` TEXT,
  `created_at` TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
  `updated_at` TIMESTAMP DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  FOREIGN KEY (`employee_id`) REFERENCES `employees`(`id`) ON DELETE CASCADE,
  FOREIGN KEY (`approved_by`) REFERENCES `users`(`id`) ON DELETE SET NULL,
  FOREIGN KEY (`level_1_approved_by`) REFERENCES `users`(`id`) ON DELETE SET NULL,
  FOREIGN KEY (`level_1_rejected_by`) REFERENCES `users`(`id`) ON DELETE SET NULL,
  FOREIGN KEY (`super_admin_approved_by`) REFERENCES `users`(`id`) ON DELETE SET NULL,
  FOREIGN KEY (`super_admin_rejected_by`) REFERENCES `users`(`id`) ON DELETE SET NULL,
  INDEX `idx_reimbursement_status` (`status`),
  INDEX `idx_reimbursement_date` (`submitted_at`),
  INDEX `idx_reimbursement_claim_code` (`claim_code`),
  INDEX `idx_reimbursement_approval_level` (`current_approval_level`),
  INDEX `idx_reimbursement_uuid` (`uuid`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- Generate UUIDs and claim codes for existing reimbursements
...
CREATE TABLE IF NOT EXISTS `project_users` (
  ...
  INDEX `idx_project_user_is_active` (`project_id`, `user_id`, `is_active`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS `project_comments` (
  ...
  `encrypted_comment` TEXT NULL,
  `is_internal` BOOLEAN DEFAULT TRUE,
  `comment_source` ENUM('CLIENT', 'INTERNAL') DEFAULT 'INTERNAL',
  ...
  INDEX `idx_comment_source` (`comment_source`),
  INDEX `idx_project_comments_parent` (`parent_comment_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
