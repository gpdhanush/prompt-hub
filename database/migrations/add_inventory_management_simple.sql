-- ============================================
-- INVENTORY MANAGEMENT TABLES (Simplified)
-- ============================================
-- Run this script if the main migration has issues
-- ============================================

USE `admin_dashboard`;

-- Drop existing tables if they exist (for re-running)
...
-- ============================================
-- 4. TRIGGER: Update inventory item timestamp
-- ============================================
DELIMITER $$
...
SELECT COUNT(*) AS inventory_attachments_count FROM inventory_attachments;
